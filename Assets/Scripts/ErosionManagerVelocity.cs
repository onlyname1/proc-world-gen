...
public struct ErosionData2
{
    ...
    public ErosionData2(int i, int j, int k, int x, int y, int z, int w, float erosionAmount, bool stopped)
    {
        this.i = i;
        this.j = j;
        this.k = k;
...
public class ErosionManagerVelocity : MonoBehaviour
{
    ...
    public void Erosion(int times)
    {
        ...
        foreach (var coord in chunkCoords)
        {
            ...
            for (int i = 0; i < times; i++)
            {
                ...
                origins.Clear();
                ErosionData2 erosionData = ErosionHelper(coord.x, j, coord.y, x, 31, z, w, 0);
                int iterations = 0;
    ...
    ErosionData2 ErosionHelper(int i, int j, int k, int x, int y, int z, int w, float erosionAmount)
    {
        ...
        if (chunk == null)
        {
            return new ErosionData2(i, j, k, x, y, z, w, erosionAmount, true);
        }
        ...
        if (cube.materials[w] == BlockType.Air)
        {
            ...
            return new ErosionData2(i, newJ, k, x, newY, z, newW, erosionAmount, false);
        }
            ...
            else
            {
                ...
                if (direction > -22.5f && direction <= 22.5f)
                {
                    if (z == 31)
                    {
                        ...
                        {
                            return new ErosionData2(i, j, k + 1, x, y, 0, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else
                    {
                        return new ErosionData2(i, j, k, x, y, z + 1, w, erosionAmount + erosionValue, false);
                    }
                }
                else if (direction > 22.5f && direction <= 67.5f)
                {
                    if (z == 31 && x == 31)
                    {
                        ...
                        {
                            return new ErosionData2(i + 1, j, k + 1, 0, y, 0, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else if (z == 31)
                    {
                        if (chunkManager.CheckGetChunk(new Vector3Int(i, j, k + 1)) != null)
                        {
                            return new ErosionData2(i, j, k + 1, x + 1, y, 0, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else if (x == 31)
                    {
                        ...
                        {
                            return new ErosionData2(i + 1, j, k, 0, y, z + 1, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else
                    {
                        return new ErosionData2(i, j, k, x + 1, y, z + 1, w, erosionAmount + erosionValue, false);
                    }
                }
                else if (direction > 67.5f && direction <= 112.5f)
                {
                    if (x == 31)
                    {
                        if (chunkManager.CheckGetChunk(new Vector3Int(i + 1, j, k)) != null)
                        {
                            return new ErosionData2(i + 1, j, k, 0, y, z, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else
                    {
                        return new ErosionData2(i, j, k, x + 1, y, z, w, erosionAmount + erosionValue, false);
                    }
                }
                else if (direction > 112.5f && direction <= 157.5f)
                {
                    if (z == 0 && x == 31)
                    {
                        if (chunkManager.CheckGetChunk(new Vector3Int(i + 1, j, k - 1)) != null)
                        {
                            return new ErosionData2(i + 1, j, k - 1, 0, y, 31, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else if (z == 0)
                    {
                        if (chunkManager.CheckGetChunk(new Vector3Int(i, j, k - 1)) != null)
                        {
                            return new ErosionData2(i, j, k - 1, x + 1, y, 31, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else if (x == 31)
                    {
                ...
                else if (direction > 157.5f || direction <= -157.5f)
                {
                    if (z == 0)
                    {
                        if (chunkManager.CheckGetChunk(new Vector3Int(i, j, k - 1)) != null)
                        {
                            return new ErosionData2(i, j, k - 1, x, y, 31, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else
                    {
                ...
                else if (direction > -157.5f && direction <= -112.5f)
                {
                    if (z == 0 && x == 0)
                    {
                        if (chunkManager.CheckGetChunk(new Vector3Int(i - 1, j, k - 1)) != null)
                        {
                            return new ErosionData2(i - 1, j, k - 1, 31, y, 31, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else if (z == 0)
                    {
                    ...
                    else if (x == 0)
                    {
                        if (chunkManager.CheckGetChunk(new Vector3Int(i - 1, j, k)) != null)
                        {
                            return new ErosionData2(i - 1, j, k, 31, y, z - 1, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else
                    {
                ...
                else if (direction > -112.5f && direction <= -67.5f)
                {
                    if (x == 0)
                    {
                        if (chunkManager.CheckGetChunk(new Vector3Int(i - 1, j, k)) != null)
                        {
                            return new ErosionData2(i - 1, j, k, 31, y, z, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else
                    {
                ...
                else
                {
                    if (z == 31 && x == 0)
                    {
                        if (chunkManager.CheckGetChunk(new Vector3Int(i - 1, j, k + 1)) != null)
                        {
                            return new ErosionData2(i - 1, j, k + 1, 31, y, 0, w, erosionAmount + erosionValue, false);
                        }
                    }
                    else if (z == 31)
                    {
